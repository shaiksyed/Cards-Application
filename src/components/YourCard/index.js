...
class YourCard extends Component {
    ...
    onClickFilteButoon = () => {
        this.setState({popUpOpened:true, filteredData:userData, showSearchIcon: false})
    }
    onClosePopup = () =>{
    ...
    return(
        ...
        <div className="filter-section">
            ...
            <button className="filter-button" onClick={this.onClickFilteButoon}>
